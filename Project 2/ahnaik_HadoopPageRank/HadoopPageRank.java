...
import indiana.cgl.hadoop.pagerank.helper.SortByValueReduce;
import indiana.cgl.hadoop.pagerank.helper.SortByValueMap;
...
public class HadoopPageRank extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		...
		job4.setMapperClass(SortByValueMap.class);
		job4.setReducerClass(SortByValueReduce.class);
